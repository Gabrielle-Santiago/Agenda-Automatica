...
# Definição das durações dos procedimentos
PROCEDURE_DURATIONS = {
...
def validar_agendamento(data, horario, proced):
    ...
    # Validação do intervalo de funcionamento
    ...
    # Validação do intervalo de pausa
    ...
    # Validação de sobreposição com agendamentos existentes
